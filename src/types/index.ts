...
// ---------------------------------------------------------------------------
// Application Activity (immutable history)
// ---------------------------------------------------------------------------
...
// Re-export NextAction from state machine for convenience
export type { NextAction } from "@/lib/applications/state-machine";
...
export type EventProcessingStatus = "pending" | "processing" | "completed" | "failed";

export interface FirestoreEventProcessing {
  eventId: string;
  eventType: DomainEventType;
  userId: string;
